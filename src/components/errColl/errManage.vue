  ...
  <div class="app-container">
    ...
    <div style="margin:10px 0">
      <el-table :data="errList" border style="width: 100%">
          ...
          <el-table-column align="center" prop="errDescription" label="错误描述" width="340"></el-table-column>
          <el-table-column align="center" prop="errCauseBy" label="错误原因" width="340"></el-table-column>
          <el-table-column align="center" prop="errSolution" label="解决方法" width="340"></el-table-column>
